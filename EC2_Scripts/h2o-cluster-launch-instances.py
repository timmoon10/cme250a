...
# -----------------------------------------------------------------------
#
os.environ['AWS_ACCESS_KEY_ID'] = 'AKIAIEM2WRE35G4WO2SA'
os.environ['AWS_SECRET_ACCESS_KEY'] = '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'
os.environ['AWS_SSH_PRIVATE_KEY_FILE'] = 'c:/Users/cliffc/Desktop/Dropbox/Presentations/2016_04_CME/cliffclickcme250atestkey.pem.txt'
